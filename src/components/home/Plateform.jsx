        ...
        <section className="plateform-section py-md-5 my-5">
            <div className="container d-flex flex-lg-row flex-column justify-content-between align-items-center">
                <div className="left-plateform mb-5 mb-lg-0">
                    ...
                    <p className="world-wolves-para">
                        Part of the reason is security, although breeding, customising and evolving your wolf requires the ownership of an Alpha &
                        Luna wolf. Therefore our holders don’t need to unstake in order to take advantage of our additional utility that we are
                        building.
                    </p>

                    <a target="_blank" href="https://crazygoatclub.io" className="learn-more">
